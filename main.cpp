...
void int_str(int rad, char r[])
{
	switch (rad)
	{
	case 1: strcpy_s(r, sizeof(r),"1"); break;
	case 2: strcpy_s(r, sizeof(r), "2"); break;
	case 3: strcpy_s(r, sizeof(r), "3"); break;
	case 4: strcpy_s(r, sizeof(r), "4"); break;
	case 5: strcpy_s(r, sizeof(r), "5"); break;
	case 6: strcpy_s(r, sizeof(r), "6"); break;
	case 7: strcpy_s(r, sizeof(r), "7"); break;
	case 8: strcpy_s(r, sizeof(r), "8"); break;
	case 9: strcpy_s(r, sizeof(r), "9"); break;
	case 10: strcpy_s(r, sizeof(r), "10"); break;
	}
...
void swap_circles(circle* cc1, circle* cc2)
{
	...
	if (abs(long(initial_x1 - cc2->x)) < 0.3 && abs(long(initial_x2 - cc1->x)) < 0.3)  //set this to speed of animation
	{
		swapping = 0;
